  ...
  return (
    <div style={ov} onClick={onClose}>
      <div style={card} onClick={e => e.stopPropagation()}>
        ...
        <div style={hdr}>
          <div>
            <div style={hdrT}>{isEditing ? 'Edit Quiz' : 'New Quiz'}</div>
          ...
          <div style={{ background: 'linear-gradient(135deg, #1a2744, #243561)', borderRadius: 'var(--radius-md)', padding: '18px 20px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginTop: '6px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,0.08)', borderRadius: '8px', padding: '8px 14px', border: '1px solid rgba(255,255,255,0.15)' }}>
                  <input type="text" inputMode="numeric" pattern="[0-9]*"
                    value={timerMins}
                    onChange={e => { const v = e.target.value.replace(/[^0-9]/g, ''); if (v === '' || parseInt(v, 10) <= 180) setTimerMins(v); }}
                    onBlur={e => { if (e.target.value === '' || isNaN(parseInt(e.target.value, 10))) setTimerMins('0'); }}
                    style={{ width: '48px', background: 'transparent', border: 'none', outline: 'none', color: 'white', fontSize: '22px', fontWeight: 800, fontFamily: 'DM Mono', textAlign: 'center', padding: 0, MozAppearance: 'textfield', WebkitAppearance: 'none' }} />
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,0.08)', borderRadius: '8px', padding: '8px 14px', border: '1px solid rgba(255,255,255,0.15)' }}>
                  <input type="text" inputMode="numeric" pattern="[0-9]*"
                    value={timerSecs}
                    onChange={e => { const v = e.target.value.replace(/[^0-9]/g, ''); if (v === '' || parseInt(v, 10) <= 59) setTimerSecs(v); }}
        ...
        <div style={ftr}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button onClick={handleSubmit} disabled={submitting}
              style={{
                padding: '11px 28px', borderRadius: 'var(--radius-md)', fontSize: '13px', fontWeight: 700, border: 'none', cursor: submitting ? 'not-allowed' : 'pointer',
